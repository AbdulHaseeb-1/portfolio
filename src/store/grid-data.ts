  ...
  grid: [
    {
      ...
      styles: {
        normal: `h-full border rounded-lg col-span-2 lg:row-span-2 flex justify-center items-center ${colorScheme.dark.background} ${colorScheme.light.background} ${colorScheme.shadow}`,
    ...
    },
    {
      ...
      styles: {
        normal:
          `h-48 md:h-56  col-span-1 flex justify-center items-center rounded-lg  ${colorScheme.shadow}`,
    ...
    },
    {
      ...
      styles: {
        normal:
          `h-48 md:h-56 rounded-2xl col-span-1 flex justify-center items-center rounded-lg  ${colorScheme.shadow}`,
        expanded:
    ...
    },
    {
      ...
      styles: {
        normal: `h-full md:h-56 rounded-2xl col-span-2 flex justify-center items-center rounded-lg ${colorScheme.dark.background} ${colorScheme.light.background}  ${colorScheme.shadow}`,
        expanded:
    ...
    },
    {
      ...
      styles: {
        normal:
          `h-48 md:h-56 rounded-2xl  col-span-2 flex justify-center items-center rounded-lg  ${colorScheme.shadow}`,
