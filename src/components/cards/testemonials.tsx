...
export default function TestemonialsCard({
  ...
  return (
    <motion.div
      ...
      className={clsx("relative border hover:border-primary/30   rounded-lg  p-4 sm:p-6  flex flex-col justify-between w-full h-full transition  transition-none group ",colorScheme.dark.background,colorScheme.light.background)}
    >
      {/* Top line + icon */}
